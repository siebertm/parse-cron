...
describe "CronParser#next" do
  [
    ...
    ["0 0 * * 2 *",           "2016-08-01 00:00",  "2016-08-02 00:00",1],
    ["0 0 * * 2#1 *",         "2016-08-01 00:00",  "2016-08-02 00:00",1],
    ["0 0 * * 2#2 *",         "2016-08-01 00:00",  "2016-08-09 00:00",1],
    ["0 0 * * 2#3 *",         "2016-08-01 00:00",  "2016-08-16 00:00",1],
    ["0 0 * * 2#4 *",         "2016-08-01 00:00",  "2016-08-23 00:00",1],
    ["0 0 * * 2#5 *",         "2016-08-01 00:00",  "2016-08-30 00:00",1],
